...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new JoystickButton(m_driverController, IOConstants.kB).onTrue(new TurnToAngle(m_driveSubsystem, 180, false));
    new JoystickButton(m_driverController, IOConstants.kX).onTrue(new TurnToAngle(m_driveSubsystem, 0, false));
    new JoystickButton(m_driverController, IOConstants.kY).onTrue(new TurnToAngle(m_driveSubsystem, 90, true));
